"""
Django settings for komatsuhattest_42823 project.
...
ROOT_URLCONF = 'komatsuhattest_42823.urls'
...
WSGI_APPLICATION = 'komatsuhattest_42823.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "komatsuhattest_42823 API",
    "DESCRIPTION": "API documentation for komatsuhattest_42823 App",
    "VERSION": "v1",
}
